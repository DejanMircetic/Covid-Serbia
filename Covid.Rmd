...
Ako smo ranije prilagodili prognoze jer su bile pristrasne za `r mean(prognoza$fitted)`. Na osnvou testa ispod vidimo da se rezidulai ne razlikuju od white noise jer je p vrijednost veca od 0.05.

```{r}
checkresiduals(prognoza)
```
```{r}
tacnost <- accuracy((prognoza$mean-57),test)
knitr::kable(tacnost, digits=2, caption="Tabela 2. Tacnost prognoziranja.")
```

Vidimo da bi na kraju imali vecu MAPE gresku prognoziranja, te da korekcija pristrasnosti nije bila dobra.